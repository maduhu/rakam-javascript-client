...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RakamClient.Collection = factory(root.RakamClient.ApiClient, root.RakamClient.SchemaField);
  }
   ...
   * @module client.model/Collection
   * @version 0.5
   */

  /**
   * Constructs a new <code>Collection</code>.
   * @alias module:client.model/Collection
   * @class
   */
   ...
   * @param {module:client.model/Collection} obj Optional instance to populate.
   * @return {module:client.model/Collection} The populated <code>Collection</code> instance.
   */
