...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RakamClient.Condition = factory(root.RakamClient.ApiClient);
  }
   ...
   * @module client.model/Condition
   * @version 0.5
   */

  /**
   * Constructs a new <code>Condition</code>.
   * @alias module:client.model/Condition
   * @class
   */
   ...
   * @param {module:client.model/Condition} obj Optional instance to populate.
   * @return {module:client.model/Condition} The populated <code>Condition</code> instance.
   */
   ...
   */
  exports.prototype['expectedValue'] = undefined;
