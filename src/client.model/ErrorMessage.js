...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RakamClient.ErrorMessage = factory(root.RakamClient.ApiClient);
  }
   ...
   * @module client.model/ErrorMessage
   * @version 0.5
   */

  /**
   * Constructs a new <code>ErrorMessage</code>.
   * @alias module:client.model/ErrorMessage
   * @class
   */
   ...
   * @param {module:client.model/ErrorMessage} obj Optional instance to populate.
   * @return {module:client.model/ErrorMessage} The populated <code>ErrorMessage</code> instance.
   */
