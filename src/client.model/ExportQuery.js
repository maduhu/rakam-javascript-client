...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RakamClient.ExportQuery = factory(root.RakamClient.ApiClient);
  }
   ...
   * @module client.model/ExportQuery
   * @version 0.5
   */

  /**
   * Constructs a new <code>ExportQuery</code>.
   * @alias module:client.model/ExportQuery
   * @class
   */
   ...
   * @param {module:client.model/ExportQuery} obj Optional instance to populate.
   * @return {module:client.model/ExportQuery} The populated <code>ExportQuery</code> instance.
   */
  ...
  /**
   * @member {module:client.model/ExportQuery.ExportTypeEnum} exportType
   */
  exports.prototype['exportType'] = undefined;
