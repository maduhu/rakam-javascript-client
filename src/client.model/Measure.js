...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RakamClient.Measure = factory(root.RakamClient.ApiClient);
  }
   ...
   * @module client.model/Measure
   * @version 0.5
   */

  /**
   * Constructs a new <code>Measure</code>.
   * @alias module:client.model/Measure
   * @class
   * @param column {String} 
   * @param aggregation {module:client.model/Measure.AggregationEnum} 
   */
  var exports = function(column, aggregation) {
    var _this = this;
   ...
   * @param {module:client.model/Measure} obj Optional instance to populate.
   * @return {module:client.model/Measure} The populated <code>Measure</code> instance.
   */
  ...
  /**
   * @member {module:client.model/Measure.AggregationEnum} aggregation
   */
