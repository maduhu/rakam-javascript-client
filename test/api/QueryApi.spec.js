...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.QueryApi();
  });
  ...
  describe('QueryApi', function() {
    ...
    describe('explain', function() {
      it('should call explain successfully', function(done) {
        //uncomment below and update the code to test explain
        //instance.explain(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('metadata', function() {
      it('should call metadata successfully', function(done) {
        ...
        //instance.metadata(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
