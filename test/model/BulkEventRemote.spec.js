...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.BulkEventRemote();
  });
  ...
  describe('BulkEventRemote', function() {
    it('should create an instance of BulkEventRemote', function() {
      // uncomment below and update the code to test BulkEventRemote
      //var instane = new RakamClient.BulkEventRemote();
      //expect(instance).to.be.a(RakamClient.BulkEventRemote);
    });
