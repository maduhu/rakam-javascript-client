...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.ConfigItem();
  });
  ...
  describe('ConfigItem', function() {
    it('should create an instance of ConfigItem', function() {
      // uncomment below and update the code to test ConfigItem
      //var instane = new RakamClient.ConfigItem();
      //expect(instance).to.be.a(RakamClient.ConfigItem);
    });
