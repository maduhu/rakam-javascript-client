...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.CreatePrecomputedTable();
  });
  ...
  describe('CreatePrecomputedTable', function() {
    it('should create an instance of CreatePrecomputedTable', function() {
      // uncomment below and update the code to test CreatePrecomputedTable
      //var instane = new RakamClient.CreatePrecomputedTable();
      //expect(instance).to.be.a(RakamClient.CreatePrecomputedTable);
    });
