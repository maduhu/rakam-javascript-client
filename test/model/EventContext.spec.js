...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.EventContext();
  });
  ...
  describe('EventContext', function() {
    it('should create an instance of EventContext', function() {
      // uncomment below and update the code to test EventContext
      //var instane = new RakamClient.EventContext();
      //expect(instance).to.be.a(RakamClient.EventContext);
    });
