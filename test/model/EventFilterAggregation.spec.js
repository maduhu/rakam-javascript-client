...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.EventFilterAggregation();
  });
  ...
  describe('EventFilterAggregation', function() {
    it('should create an instance of EventFilterAggregation', function() {
      // uncomment below and update the code to test EventFilterAggregation
      //var instane = new RakamClient.EventFilterAggregation();
      //expect(instance).to.be.a(RakamClient.EventFilterAggregation);
    });
