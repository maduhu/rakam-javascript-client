...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.ModuleDescriptor();
  });
  ...
  describe('ModuleDescriptor', function() {
    it('should create an instance of ModuleDescriptor', function() {
      // uncomment below and update the code to test ModuleDescriptor
      //var instane = new RakamClient.ModuleDescriptor();
      //expect(instance).to.be.a(RakamClient.ModuleDescriptor);
    });
