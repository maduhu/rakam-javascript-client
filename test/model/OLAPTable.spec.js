...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.OLAPTable();
  });
  ...
  describe('OLAPTable', function() {
    it('should create an instance of OLAPTable', function() {
      // uncomment below and update the code to test OLAPTable
      //var instane = new RakamClient.OLAPTable();
      //expect(instance).to.be.a(RakamClient.OLAPTable);
    });
