...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.RealTimeReport();
  });
  ...
  describe('RealTimeReport', function() {
    it('should create an instance of RealTimeReport', function() {
      // uncomment below and update the code to test RealTimeReport
      //var instane = new RakamClient.RealTimeReport();
      //expect(instance).to.be.a(RakamClient.RealTimeReport);
    });
