...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.Recipe();
  });
  ...
  describe('Recipe', function() {
    it('should create an instance of Recipe', function() {
      ...
      //var instane = new RakamClient.Recipe();
      //expect(instance).to.be.a(RakamClient.Recipe);
    });
    ...
    it('should have the property materializedViews (base name: "materialized_views")', function() {
      // uncomment below and update the code to test the property materializedViews
      //var instane = new RakamClient.Recipe();
      //expect(instance).to.be();
    });

    it('should have the property continuousQueries (base name: "continuous_queries")', function() {
      // uncomment below and update the code to test the property continuousQueries
      //var instane = new RakamClient.Recipe();
      //expect(instance).to.be();
    });
