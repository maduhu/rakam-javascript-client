...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RakamClient.ResponseQuery();
  });
  ...
  describe('ResponseQuery', function() {
    it('should create an instance of ResponseQuery', function() {
      // uncomment below and update the code to test ResponseQuery
      //var instane = new RakamClient.ResponseQuery();
      //expect(instance).to.be.a(RakamClient.ResponseQuery);
    });
